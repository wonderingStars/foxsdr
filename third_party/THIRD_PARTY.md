...
| Dear ImGui Android backend | https://github.com/ocornut/imgui | tag `v1.92.8-docking`, files `backends/imgui_impl_android.{cpp,h}` (the same tag as the rest of the vendored ImGui; fetched 2026-09-16 for the Android port) | `https://raw.githubusercontent.com/ocornut/imgui/v1.92.8-docking/backends/imgui_impl_android.cpp` and `.h` | cpp `e33ad74760194d09f75e16535884ce6857f0f769a11745e332445e1249e5c09a`, h `9d8bf1ee2eba8520d9b85510201792d8ea754545654fc2c8f92db1dc811f4bab` | MIT (`imgui/LICENSE.txt`) | `third_party/imgui/backends/` |
